...
//                   children: [
//                     AppText(controller.selectedOptionForRole.value, color: AppColors.takeQuickAssessmentColor.withValues(alpha: 0.40), fontSize: 14, fontWeight: FontWeight.w500),
//                     AnimatedRotation(
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            border: Border.all(color: AppColors.takeQuickAssessmentColor.withValues(alpha: 0.40)),
            borderRadius: BorderRadius.vertical(top: const Radius.circular(10), bottom: Radius.circular(isDropdownOpen ? 0 : 10)),
          ),
          child: InkWell(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  AppText(
                    selectedOption.isEmpty ? hintText : selectedOption,
                    color: AppColors.takeQuickAssessmentColor.withValues(alpha: 0.40),
                    fontSize: 14,
        ...
        AnimatedContainer(
          duration: const Duration(milliseconds: 200),
          curve: Curves.easeInOut,
          height: isDropdownOpen ? (options.length - (selectedOption.isEmpty ? 0 : 1)) * 44.0 : 0,
          child: SingleChildScrollView(
            physics: const NeverScrollableScrollPhysics(),
            child: Container(
              decoration: BoxDecoration(
                      ...
                      Material(
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 12.0),
                            decoration: BoxDecoration(border: Border(top: BorderSide(color: Colors.grey.shade300))),
                            child: AppText(option, color: AppColors.colorHintTextField, fontSize: 15, fontWeight: FontWeight.w500),
                          ),
                        ),
                      ),
                ],
