      ...
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 xl:gap-12">
        ...
        <div className="flex flex-col justify-center w-full lg:w-1/2 order-1 lg:order-2">
          <div className="text-2xl sm:text-3xl md:text-4xl font-medium leading-snug text-[#4A4B4F] mb-4">
            "A little care for the one who cares for everyone — you"
          </div>
          <p className="text-base sm:text-lg md:text-xl pt-2 font-normal text-[#4A4B4F] mb-4 text-center md:text-left">
            <strong>LittleHugs</strong> is your everyday wellness companion — designed for the woman who wants to check in with herself before things feel too heavy.
          </p>
          <p className="text-base sm:text-lg md:text-xl font-normal text-[#4A4B4F] mb-4 text-center md:text-left">
            We help you notice how you're really doing — and gently guide you with simple, expert-informed routines that bring clarity, not overwhelm.
          </p>
          <p className="text-base sm:text-lg md:text-xl font-normal text-[#4A4B4F] text-center md:text-left">
            Whether you're leading at work, running a home, or simply stretched thin and unseen — LittleHugs is here for <strong>you</strong>.
          </p>
        </div>
      </div>
    </section>
