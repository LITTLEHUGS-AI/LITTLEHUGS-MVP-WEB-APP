...
export default function AssesmentChild() {

    const { questions: goalQuestions } = useAssessmentQuestions('goal', 2);
    const { questions: intentQuestions } = useAssessmentQuestions('intent', 2);
