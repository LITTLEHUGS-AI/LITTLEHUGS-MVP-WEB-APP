    ...
    <div className="flex flex-col w-full h-full px-3 pt-6 md:px-0 font-quicksand">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-1">
          ...
          <p
            ...
            onClick={() => setIsModalOpen(true)}
          >
            {userProfile?.partner_type === 'Therapy Center' ? "Add Therapist" : "Add Team Member"}
          </p>
        </div>
      </div>
      ...
      {fetchLoading ? (
        ...
        <div className="flex flex-col items-center justify-center h-40 text-gray-500 text-base">
          {userProfile?.partner_type === 'Therapy Center' ? "No therapist, please add by clicking on add Therapist button" : "No team member, please add by clicking on add Team Member button"}
        </div>
      ) : (
        <>
      ...
      <CommonModal
        ...
        title={
          <div className="w-full text-center font-normal text-[16px] md:text-2xl">
            {userProfile?.partner_type === 'Therapy Center' ? "Add Therapist" : "Team Member"}
          </div>
        }
        footer={null}
      >
        <div className="flex flex-col gap-4 mt-4 w-full md:flex-row md:gap-4">
          <div className="flex flex-col w-full md:w-1/2">
            <label className="mb-1 text-gray-700 text-sm">
              {userProfile?.partner_type === 'Therapy Center' ? "Therapist Name" : "Team Member Name"}
            </label>
            <Input
              placeholder={userProfile?.partner_type === 'Therapy Center' ? "* Therapist Name" : "* Team Member Name"}
              value={name}
